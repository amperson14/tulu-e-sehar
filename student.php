...
$sid = $fname = $classroom = $dob = $address = $parent = " ";
              ...
              <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input name="sid" type="text" class="form-control" id="exampleInputPassword1"
                        placeholder="Enter Student ID No" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name='dob' class="form-control pull-right" id="datepicker"
                          placeholder="Select Student's Data of Birth">
                      </div>
                      <!-- /.input group -->
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1"
                        aria-hidden="true" name="classroom">
                      ...
                      <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1"
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<option value='" . $row["pid"] . "' >" . $row["fname"] .  " - ID:" . $row["pid"] . "</option>";
                          }
                        }
                ...
                if (isset($_POST['submit'])) {
                  ...
                  try {
                    ...
                    $sql = "INSERT INTO student (sid,fname,bday,address,parent,classroom) VALUES ('" . $sid . "', '" . $fname . "','" . $dob . "','" . $address . "','" . $parent . "','" . $classroom . "')";
              ...
              <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name='dob' class="form-control pull-right" id="datepicker"
                          placeholder="Select Student's Data of Birth" value=<?php echo "'" . $dob . "'"; ?>>
                      </div>
                      <!-- /.input group -->
                    ...
                    <div class="form-group">
                      ...
                      <label>Parent</label>
                      <select name="parent" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo " value='" . $row["pid"] . "' >" . $row["fname"] . " - ID:" . $row["pid"] . "</option>";
                          }
                        }
                ...
                if (isset($_POST['submit'])) {
                  ...
                  try {
                    ...
                    $sql = "UPDATE student set fname='" . $fname . "', bday='" . $dob . "',address='" . $address . "',parent=" . $parent . ",classroom='" . $classroom . "' where sid='" . $sid . "'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      // output data of each row
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr><td> " . $row["sid"] . " </td><td> " . $row["fname"] . " </td><td> " . $row["bday"] . "</td><td>" . $row["address"] . "</td><td>" . $row["classroom"] . "</td><td>" . $row["parent"] . "</td><td><a href='student.php?update=" . $row["sid"] . "'><small class='label  bg-orange'>Update</small></a></td></tr>";
                      }
                    }
